        ...
        <div class="filter-bottom">
            ...
            <div class="filter-right">
                ...
                <form
                    id="filterForm"
                    method="GET"
                    action="{{ route('admin.transaksi.penjualan') }}"
                    class="filter-form">
...
history.replaceState({}, "", url);
    ...
    fetch(`/admin/transaksi/penjualan/search?${params.toString()}`)
        ...
        .then(data => {
            ...
            if (data.data.length === 0) {
                ...
                data.data.forEach(function(sale){
                    ...
                    rows += renderSaleRow(sale);

                });

            }

            document.getElementById("salesTableBody").innerHTML = rows;
